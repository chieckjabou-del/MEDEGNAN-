...
export default function CaseStudyCard({ study }: { study: CaseStudyRecord }) {
  return (
    ...
    >
      ...
      {study.metric && (
        <p className="mt-3 font-mono text-2xl tabular text-accent-hover">{study.metric.value}</p>
      )}
      ...
      <span className="mt-5 inline-flex items-center gap-1 text-sm font-medium text-ink underline decoration-accent decoration-2 underline-offset-4 group-hover:text-accent-hover">
